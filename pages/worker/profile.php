            ...
            <div class="header-actions">
                ...
                <div class="user-menu" id="userMenu">
                    <button class="user-menu-btn">
                        <div class="avatar" style="background: linear-gradient(135deg, #48bb78, #38a169);">AD</div>
                        <span class="user-name">Worker</span>
                ...
                <div class="card-body">
                    <div class="profile-form">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" value="Worker User" />
                        </div>
                        <div class="form-group">
                            <label>Email</label>
