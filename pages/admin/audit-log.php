...
<head>
    ...
    <title>Audit Log - Tweak Easy</title>
                    ...
                    <div class="activity-timeline">
                        <div class="activity-log-item">
                            ...
                            <div class="activity-details">
                                <span class="activity-action">User John Doe logged in</span>
                                <span class="activity-meta">IP: 192.168.1.1 • 5 minutes ago</span>
                            </div>
                        </div>
                        <div class="activity-log-item">
                            ...
                            <div class="activity-details">
                                <span class="activity-action">System settings updated by Admin</span>
                                <span class="activity-meta">Changed notification preferences • 2 hours ago</span>
                            </div>
                        </div>
                        <div class="activity-log-item">
                            ...
                            <div class="activity-details">
                                <span class="activity-action">Failed login attempt</span>
                                <span class="activity-meta">Username: admin • IP: 203.0.113.0 • 3 hours ago</span>
                            </div>
                        </div>
                    </div>
                </div>
