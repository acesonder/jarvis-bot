...
<head>
    ...
    <title>Settings - Tweak Easy</title>
                    ...
                    <div class="system-status-list">
                        <div class="status-item">
                            <div class="status-info">
                                ...
                                <span class="status-desc">Send system notifications via email</span>
                            </div>
                            <label class="switch">
                        ...
                        <div class="status-item">
                            <div class="status-info">
                                <span class="status-name">Two-Factor Authentication</span>
                                <span class="status-desc">Require 2FA for admin users</span>
                            </div>
                            <label class="switch">
                                <input type="checkbox" checked>
                                <span class="slider"></span>
                        ...
                        <div class="status-item">
                            <div class="status-info">
                                <span class="status-name">Maintenance Mode</span>
                                <span class="status-desc">Temporarily disable public access</span>
                            </div>
                            <label class="switch">
                                <input type="checkbox">
                                <span class="slider"></span>
