...
<head>
    ...
    <title>Profile - Tweak Easy</title>
            ...
            <div class="header-actions">
                ...
                <div class="user-menu" id="userMenu">
                    <button class="user-menu-btn">
                        <div class="avatar" style="background: linear-gradient(135deg, #9f7aea, #805ad5);">AD</div>
                        <span class="user-name">Provider</span>
                ...
                <div class="card-body">
                    <div class="profile-form">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" value="Provider User" />
                        </div>
                        <div class="form-group">
                            <label>Email</label>
                            <input type="email" class="form-control" value="admin@tweakeasy.org" />
                        </div>
                        <div class="form-group">
                            <label>Phone</label>
                        ...
                        <div class="form-group">
                            <label>Role</label>
                            <input type="text" class="form-control" value="Provideristrator" disabled />
                        </div>
                    </div>
                </div>
            </div>
