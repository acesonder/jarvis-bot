...
<head>
    ...
    <title>Resources - Tweak Easy</title>
    ...
    <main class="main-content">
        ...
        <div class="dashboard-content">
            <div class="page-header">
                <h1>Resources</h1>
                <p>Find local services and support</p>
            </div>
            ...
            <div id="health" class="dashboard-card">
                <div class="card-header">
                ...
                <div class="card-body">
                    <div class="resource-list">
                        <div class="resource-item">
                            ...
                            <p>Free and low-cost health services including primary care, mental health, and substance use treatment</p>
                            <p><strong>Phone:</strong> (555) 123-4567 | <strong>Address:</strong> 123 Main St</p>
                        </div>
                        <div class="resource-item">
                            <h4>Mobile Health Clinic</h4>
                            <p>Walk-in health services, vaccinations, and health screenings</p>
                            <p><strong>Phone:</strong> (555) 234-5678 | <strong>Schedule:</strong> Mon-Fri 9am-5pm</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <!-- Housing Section -->
            <div id="housing" class="dashboard-card">
                <div class="card-header">
                ...
                <div class="card-body">
                    <div class="resource-list">
                        <div class="resource-item">
                            <h4>Emergency Shelter Network</h4>
                            <p>24/7 emergency shelter, meals, and case management services</p>
                            <p><strong>Hotline:</strong> (555) 345-6789 | <strong>Available:</strong> 24/7</p>
                        </div>
                        <div class="resource-item">
                            <h4>Housing First Program</h4>
                            <p>Permanent supportive housing with wraparound services</p>
                            <p><strong>Phone:</strong> (555) 456-7890 | <strong>Address:</strong> 456 Oak Ave</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div id="food" class="dashboard-card">
                <div class="card-header">
                ...
                <div class="card-body">
                    <div class="resource-list">
                        <div class="resource-item">
                            ...
                            <p>Food distribution, nutritional support, and cooking classes</p>
                            <p><strong>Phone:</strong> (555) 567-8901 | <strong>Hours:</strong> Tue-Thu 10am-2pm</p>
                        </div>
                        <div class="resource-item">
                            <h4>Community Meal Program</h4>
                            <p>Free hot meals served daily, no questions asked</p>
                            <p><strong>Address:</strong> 789 Elm St | <strong>Meals:</strong> Lunch 12-1pm, Dinner 6-7pm</p>
                        </div>
                    </div>
                </div>
            </div>
